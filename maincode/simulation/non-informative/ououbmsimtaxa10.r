#setwd("/Users/TerryLai/Dropbox/TerryLai/simulation_V2/ououbm/")
#setwd("/Users/terrylai/Dropbox/TerryLai/simulation_V2/ououbm/")
rm(list=ls())
#source("/Users/TerryLai/Dropbox/TerryLai/R_code/abc_V3/ououbmabc.r")
source("/Users/terrylai/Dropbox/TerryLai/R_code/abc_unif_prior/ououbmabc.r")
root<-0
#true params
true.alpha.y<-0.15
true.alpha.x<-0.1
...
prior.model.params=c(alpha.y.min,alpha.y.max, alpha.x.min,alpha.x.max, theta.x.min, theta.x.max, sigma.sq.x.min, sigma.sq.x.max, tau.min, tau.max)
names(prior.model.params)<-c("alpha.y.min","alpha.y.max", "alpha.x.min","alpha.x.max", "theta.x.min", "theta.x.max", "sigma.sq.x.min", "sigma.sq.x.max", "tau.min", "tau.max")
