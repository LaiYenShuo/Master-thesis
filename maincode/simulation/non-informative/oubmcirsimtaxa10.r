#setwd("/Users/TerryLai/Dropbox/TerryLai/simulation_V2/oubmcir/")
#setwd("/Users/terrylai/Dropbox/TerryLai/simulation_V2/oubmcir/")
rm(list=ls())
#source("/Users/TerryLai/Dropbox/TerryLai/R_code/abc_V3/oubmcirabc.r")
source("/Users/terrylai/Dropbox/TerryLai/R_code/abc_unif_prior/oubmcirabc.r")
root<-0
#true params
true.alpha.y<-0.15
true.sigma.x<-1
...
prior.model.params=c(alpha.y.min,alpha.y.max, sigma.x.min, sigma.x.max, alpha.tau.min,alpha.tau.max, theta.tau.a, theta.tau.b, sigma.tau.min, sigma.tau.max)
names(prior.model.params)<-c("alpha.y.min","alpha.y.max", "sigma.x.min", "sigma.x.max", "alpha.tau.min","alpha.tau.max", "theta.tau.a", "theta.tau.b", "sigma.tau.min", "sigma.tau.max")
